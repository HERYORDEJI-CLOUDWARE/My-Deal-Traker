...
import {View, Text, SafeAreaView, Platform, StyleSheet, TouchableOpacity, Switch, Image} from 'react-native';
...
const ReferralView = () => {
    ...
    const submitHandler = async () => { 
        ...
        //    console.log(data)
           axios.post('http://mydealtracker.staging.cloudware.ng/api/mortgage_broker.php', data, {
            headers: {
    ...
    return (
           <View style={styles.container}>
            ...
            <View style={{ marginHorizontal:20, marginTop:40}}>
               ...
               <Text style={{color:'white', fontSize:18}}>Choose Referral Source</Text> 
                 <TouchableOpacity style={{marginTop:-20}}  onPress={ReferralView}> 
                            <Picker
                                    selectedValue={referral}
                                    style={Platform.OS == 'ios' ? styles.referralIOS : styles.referralAndroid }
              ...
              <View style={{marginHorizontal:20, marginTop:-10}}>
                    <Text style={{ fontWeight:'bold', fontSize:20, color:colors.white, marginBottom:5}}>Phone Number</Text>
                    <TextInput
                ...
                <View style={{ marginLeft:20}}>
                    <Text style={{ fontSize:20, fontWeight:'bold', color:colors.white}}>Current Address</Text>
                    <TextInput
                    ...
                    <View style={{marginTop:5, flexDirection:'row'}} >
                        ...
                        />
                        <Text style={{color:colors.white, marginTop:4, marginLeft:3}}>Send me notifications for transaction updates</Text>
                    </View>
                    { showReferral === true ? 
                    <View>
                     
                       <View>
                            <Text style={{color:colors.white, fontWeight:'bold', fontSize:18}}>Referrer Name</Text>
                            <TextInput 
                        ...
                        <View>
                            <Text style={{color:colors.white, fontWeight:'bold', fontSize:18}}>Referrer Phone</Text>
                            <TextInput 
                    ...
                    >
                        <Text style={{fontSize:18, fontWeight:'bold', color:colors.white}}> Send</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.waiveFinancingButton} onPress={()=>navigation.navigate('mortgageFinancing', {transaction_id:transaction_id})}>
                        <Text style={{color:colors.white, fontSize:18, textAlign:'center' }}>Waive Financing</Text>
                    </TouchableOpacity>
                </View>
           </View>
