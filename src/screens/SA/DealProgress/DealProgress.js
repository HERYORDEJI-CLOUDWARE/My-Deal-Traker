...
const SaDealProgress = ({ transaction }) => {
      ...
      <View style={{ paddingLeft: 10 }}>
        <View style={{ paddingHorizontal: 20 }}>
          ...
          >
            ...
            <View style={styles.action_status}>
              ...
              <Text style={styles.status}>{transaction.make_offer_status != "0" ? "Completed" : "Not completed"}</Text>
            </View>
          </View>
        </View>
          ...
          >
            <View style={styles.action_status}>
              ...
              <Text style={{ ...styles.status, color: colors.lightGrey }}>
                {transaction.financing_status != "0" ? "Completed" : "Not completed"}
              </Text>
            </View>
            <View style={styles.action_status}>
              <Text style={styles.progressText}>Inspection</Text>
              <Text style={{ ...styles.status, color: colors.lightGrey }}>
                {transaction.inspection_status != "0" ? "Completed" : "Not completed"}
              </Text>
            </View>
            <View style={styles.action_status}>
              <Text style={styles.progressText}>Appraisal</Text>
              <Text style={{ ...styles.status, color: colors.lightGrey }}>
                {transaction.appraisal_status != "0" ? "Completed" : "Not completed"}
              </Text>
            </View>
            <View style={styles.action_status}>
              <Text style={styles.progressText}>Repairs</Text>
              <Text style={{ ...styles.status, color: colors.lightGrey }}>
                {transaction.repairs_status != "0" ? "Completed" : "Not completed"}
              </Text>
            </View>
          </View>
        </View>
        ...
        <View style={{ paddingHorizontal: 20 }}>
          <View style={{ flexDirection: "row", alignItems: "center" }}>
            ...
            <Text style={{ ...styles.status, color: colors.lightGrey }}>
                {transaction.closing_status != "0" ? "Completed" : "Not completed"}
              </Text>
          </View>
